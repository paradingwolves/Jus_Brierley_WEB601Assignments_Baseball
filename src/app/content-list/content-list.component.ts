...
export class ContentListComponent implements OnInit{
  ...
  contentItem5:Content = {
    ...
    type:"Achievement",
    tags:[ "Hits","Ichiro", "Record", "Season"]
  };
  contentItem6:Content = {
    ...
    type:"Blunders",
    tags:["Gus Weyhing", "Hit Batters", "Most hit batters", "MLB"]
  };
  contentItem7:Content = {
    ...
    type:"Blunders",
    tags:["Derek Jeter", "Defense", "Worst Defender", "Overrated"]
  };
  contentItem8:Content = {
    ...
    type:"Achievement",
    tags:["Saves","Most Consecutive Saves", "Eric Gagne", "Record"]
  };
